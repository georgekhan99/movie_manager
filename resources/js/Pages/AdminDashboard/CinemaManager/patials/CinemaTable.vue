...
<div class="max-w-full overflow-x-auto">
    <div class="min-w-[1170px]">
      <!-- table header start -->
      <div class="grid grid-cols-12 bg-[#F9FAFB] px-5 py-4 dark:bg-meta-4 lg:px-7.5 2xl:px-11 bg-blue-400 rounded-sm">
        ...
        <div class="col-span-1">
          <h5 class="font-medium float-right text-[#637381] dark:text-bodydark">Action</h5>
        </div>
      </div>
      <!-- table header end -->
