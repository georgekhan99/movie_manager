            ...
            <div class="p-6.5">
                ...
                <div class="mb-4.5">
                    ...
                    <select
                        ...
                        id=""
                    >
                    <option v-for="r in props.roleList" :value="r.id" :key="r.id">{{ r.name }}</option>
                    </select>
                ...
                <div class="mb-4.5">
                    ...
                    <select v-model="form.Company" class="input-style" name="company_selector" id="">
                        <option v-for="c in props.company_list" :value="c.id" :key="c.id">{{ c.id }} - {{ c.company_legalname }}</option>
                    </select>  
                </div>
